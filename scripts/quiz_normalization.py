    ...
    for section_index, section in enumerate(section_rows, start=1):
        ...
        structure = {
            ...
            "extensions": {
                ...
                # question. Every observed item also carries its own weight and
                # the two never disagree, so this is not where points are read
                # from; it is kept so the declaring structure can be
