...
class JourneyEngine:
    ...
    def run(self) -> tuple[dict[str, Any], Path, Path]:
        ...
        try:
            ...
            baseline = unbind / "reviewer-baseline.xlsx"
            edited = unbind / "reviewer-edited.xlsx"
            shutil.copyfile(extracted_reviewer, baseline)
            shutil.copyfile(extracted_reviewer, edited)
